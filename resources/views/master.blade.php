...
<link href="sources/site/style.css" rel="stylesheet" type="text/css" />
<script src="sources/site/js/jquery-1.4.2.min.js" type="text/javascript"></script>
<script src="sources/site/js/cufon-yui.js" type="text/javascript"></script>
<script src="sources/site/js/cufon-replace.js" type="text/javascript"></script>
<script src="sources/site/js/Gill_Sans_400.font.js" type="text/javascript"></script>
<script src="sources/site/js/script.js" type="text/javascript"></script>
<!--[if lt IE 7]>
...
<!-- HEADER -->
			<div id="header">
				<div class="row-1">
					...
					<ul>
						<li><a href="sources/site/index.html"><img src="sources/site/images/icon1-act.gif" alt="" /></a></li>
						<li><a href="sources/site/contact-us.html"><img src="sources/site/images/icon2.gif" alt="" /></a></li>
						<li><a href="sources/site/sitemap.html"><img src="sources/site/images/icon3.gif" alt="" /></a></li>
					</ul>
				</div>
				<div class="row-2">
					<ul>
						<li><a href="sources/site/index.html" class="active">Home</a></li>
						<li><a href="sources/site/about-us.html">About</a></li>
						<li><a href="sources/site/articles.html">Articles</a></li>
						<li><a href="sources/site/contact-us.html">Contacts</a></li>
						<li class="last"><a href="sources/site/sitemap.html">Sitemap</a></li>
					</ul>
				</div>
			</div>
<!-- CONTENT -->
			<div id="content">
					...
					<div class="border-right">
						<div class="border-left">
							<div class="inner">
								...
								<div class="img-box1"><img src="sources/site/images/1page-img1.jpg" alt="" />This website template can be delivered in two packages - with PSD source files included and without them. If you need PSD source files, please go to the template download page at TemplateMonster to leave the e-mail address that you want the template ZIP package to be delivered to.</div>
								<p>This website template has several pages: <a href="sources/site/index.html">Home</a>, <a href="about-us.html">About us</a>, <a href="articles.html">Articles</a> (with Article page), <a href="contact-us.html">Contact us</a> (note that contact us form – doesn’t work), <a href="sitemap.html">Site Map</a>.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="content">
					...
					<ul class="movies">
						<li>
							<h4>Toy Story 3</h4><img src="sources/site/images/1page-img2.jpg" alt="" />
						...
						<li>
							<h4>Prince of Percia: Sands of Time</h4><img src="sources/site/images/1page-img3.jpg" alt="" />
						...
						<li class="last">
							<h4>The Twilight Saga: Eclipse</h4><img src="sources/site/images/1page-img4.jpg" alt="" />
