      ...
      <div class="col-md-12" >
        <dir class="rowduy" style="padding-top: 20px !important;">
          <div class="heading text-center" style="margin-right: 40px;" id="dang">
            <a href="javascript:void(null);"><h4 onclick="hienPhimdangchieu()">Phim đang chiếu</h4></a>                         
          </div> 
          <div class="heading text-center" id="sap"> 
            <a href="javascript:void(null);"><h4 onclick="hienPhimsapchieu()">Phim sắp chiếu</h4> </a>                
          </div>   
        </dir>
        <!--  aaa -->
        <!-- Carousel Start-->
