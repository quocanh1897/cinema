              ...
              <div class="homepage owl-carousel">
                <div class="item">
                  <div class="row">
                    <div class="col-md-5 text-right">
                      <p><img src="sources/img/logo.png" alt="" class="ml-auto"></p>
                      <h1>Multipurpose responsive theme</h1>
                      <p>Business. Corporate. Agency.<br>Portfolio. Blog. E-commerce.</p>
                    </div>
                    <div class="col-md-7"><img src="sources/img/template-homepage.png" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="item">
                  <div class="row">
                    <div class="col-md-7 text-center"><img src="sources/img/template-mac.png" alt="" class="img-fluid"></div>
                    <div class="col-md-5">
                ...
                <div class="item">
                  <div class="row">
                    ...
                    <div class="col-md-7"><img src="sources/img/template-easy-customize.png" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="item">
                  <div class="row">
                    <div class="col-md-7"><img src="sources/img/template-easy-code.png" alt="" class="img-fluid"></div>
                    <div class="col-md-5">
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="sources/img/person-1.jpg" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="sources/img/person-2.jpg" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="sources/img/person-3.png" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="sources/img/person-4.jpg" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
...
<section style="background: url(img/fixed-background-2.jpg) center top no-repeat; background-size: cover;" class="bar no-mb color-white text-center bg-fixed relative-positioned">
        ...
        <div class="container">
          ...
          <p class="text-center"><a href="sources/index2.html" class="btn btn-template-outlined-white btn-lg">See another homepage</a></p>
        </div>
</section>
          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="home-blog-post">
                <div class="image"><img src="sources/img/portfolio-4.jpg" alt="..." class="img-fluid">
                ...
                <div class="text">
                  ...
                  <p class="author-category">By <a href="#">John Snow</a> in <a href="sources/blog.html">Webdesign</a></p>
            ...
            <div class="col-lg-3">
              <div class="home-blog-post">
                <div class="image"><img src="sources/img/portfolio-3.jpg" alt="..." class="img-fluid">
                  <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                </div>
                <div class="text">
            ...
            <div class="col-lg-3">
              <div class="home-blog-post">
                <div class="image"><img src="sources/img/portfolio-5.jpg" alt="..." class="img-fluid">
                  <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                </div>
                <div class="text">
            ...
            <div class="col-lg-3">
              <div class="home-blog-post">
                <div class="image"><img src="sources/img/portfolio-6.jpg" alt="..." class="img-fluid">
                  <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                </div>
                <div class="text">
                  <h4><a href="#">Fashion Now </a></h4>
...
<section class="bar bg-gray">
        <div class="container">
          ...
          <ul class="list-unstyled owl-carousel customers no-mb">
            <li class="item"><img src="sources/img/customer-1.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="sources/img/customer-2.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="sources/img/customer-3.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="sources/img/customer-4.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="sources/img/customer-5.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="sources/img/customer-6.png" alt="" class="img-fluid"></li>
          </ul>
        </div>
</section>
@endsection